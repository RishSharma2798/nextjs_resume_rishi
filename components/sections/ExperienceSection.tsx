...
const experiences = [
  {
    ...
    projects: [
      {
        name: "Ecommerce Platform (Product)",
        achievements: [
          ...
          "Implemented Google reCAPTCHA v3 to safeguard forms and endpoints, reducing spam and mitigating potential DDoS attacks.",
          "Integrated Contentful CMS to power popular categories and banner components, enabling dynamic content updates without code deployments.",
        ],
      ...
      <div className="container px-4 md:px-6" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            My professional journey as a Full Stack Developer, showcasing my
